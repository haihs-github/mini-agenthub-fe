...
export const translations = {
  en: {
    ...
    desc_new_res: "Add new user",
    desc_res_data: "Read user details",
    desc_edit_content: "Edit user information",
    desc_remove_assets: "Delete user",
    desc_new_groups: "Add new group",
    desc_group_data: "Read group details",
    desc_edit_group: "Edit group information",
    desc_delete_group: "Delete group",
  ...
  vi: {
    ...
    desc_new_res: "Thêm người dùng mới",
    desc_res_data: "Đọc thông tin người dùng",
    desc_edit_content: "Chỉnh sửa thông tin người dùng",
    desc_remove_assets: "Xóa người dùng",
    desc_new_groups: "Thêm nhóm mới",
    desc_group_data: "Đọc thông tin nhóm",
    desc_edit_group: "Chỉnh sửa thông tin nhóm",
    desc_delete_group: "Xóa nhóm",
