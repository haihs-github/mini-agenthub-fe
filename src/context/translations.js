// BKAV HaiHS : Cấu hình định nghĩa từ điển ngôn ngữ đa quốc gia toàn hệ thống - start
export const translations = {
  en: {
    ...
    // --- NEW MODAL & SIDEBAR TRANSLATIONS (i18n Debug keys) ---
    new_conversation: "New conversation",
    rename: "Rename",
    delete_chat: "Delete Chat",
    rename_conversation: "Rename Conversation",
    delete_warning: "Delete Warning",
    rename_description: "Enter new title for this conversation:",
    delete_confirm_msg: "Are you sure you want to delete conversation \"{title}\"? This action cannot be undone.",
    placeholder_rename: "Enter new name...",
    cancel: "Cancel",
    confirm: "Confirm",
  ...
  vi: {
    ...
    doneBtn: "Hủy",
    confirmPhone: "Xong",
    clear_button: "Xóa lịch sử chat",

    // --- PERSONAL INFO ---
    personalInfo: "Thông tin cá nhân",
    phoneNumber: "Thông tin liên lạc",
    address: "Địa chỉ",
    ...
    pwd_too_short: "Mật khẩu phải có tối thiểu 6 ký tự",
    ...
    // --- NEW MODAL & SIDEBAR TRANSLATIONS (i18n Debug keys) ---
    new_conversation: "Đoạn hội thoại mới",
    rename: "Đổi tên",
    delete_chat: "Xóa hội thoại",
    rename_conversation: "Đổi tên cuộc trò chuyện",
    delete_warning: "Cảnh báo xóa dữ liệu",
    rename_description: "Nhập tên tiêu đề mới cho phòng chat này của bạn:",
    delete_confirm_msg: "Bạn có chắc chắn muốn xóa đoạn hội thoại \"{title}\" không? Hành động này không thể hoàn tác.",
    placeholder_rename: "Nhập tên mới...",
    cancel: "Hủy bỏ",
    confirm: "Xác nhận",
    untitled_conversation: "Đoạn hội thoại không tên",
  },
};
// BKAV HaiHS : Cấu hình định nghĩa từ điển ngôn ngữ đa quốc gia toàn hệ thống - end
